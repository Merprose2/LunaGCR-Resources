...
function action_group_load(context,evt)
    ...
    for i = 1, #StartBlockerMap do
        ...
        local state = ScriptLib.GetGadgetStateByConfigId(context, base_info.group_id, blocker)
...
function LF_Is_In_Block_State(context,blocker_id)
    local state = ScriptLib.GetGadgetStateByConfigId(context, base_info.group_id,blocker_id)
