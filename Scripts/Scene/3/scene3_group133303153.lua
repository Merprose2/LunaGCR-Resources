...
function action_EVENT_ENTER_REGION_153009(context, evt)
	...
	-- 触发镜头注目，注目位置为坐标{x=-1355.83, y = 260.989, z=3313.716}，持续时间为2秒，并且为强制注目形式，不广播其他玩家
		local pos = {x=-1355.830, y=260.989, z=3313.716}
...
function action_EVENT_ENTER_REGION_153019(context, evt)
	-- 触发镜头注目，注目位置为坐标{x=-1356.313, y = 263.390, z=3305.728}，持续时间为2秒，并且为强制注目形式，不广播其他玩家
		local pos = {x=-1356.313, y=263.390, z=3305.728}
	  local pos_follow = {x=0, y=0, z=0}
