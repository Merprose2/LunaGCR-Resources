...
function action_EVENT_LUA_NOTIFY_3029(context, evt)
	-- 触发镜头注目，注目位置为坐标{x=-2455.108, y = 336.458, z=3950.668}，持续时间为5秒，并且为强制注目形式，不广播其他玩家
		local pos = {x=-2455.108, y=336.458, z=3950.668}
	  local pos_follow = {x=13.638, y = 28.763, z=25.558}
