...
function action_EVENT_ENTER_REGION_444012(context, evt)
	...
	-- 触发镜头注目，注目位置为坐标{x = -825.492, y = 129.546, z=1942.051}，持续时间为3秒，并且为强制注目形式，不广播其他玩家
		local pos = {x=-825.492, y=129.546, z=1942.051}
	  local pos_follow = {x = -825.492, y = 129.546, z=1942.051}
