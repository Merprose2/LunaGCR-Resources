...
function action_EVENT_ENTER_REGION_378026(context, evt)
	...
	-- 触发镜头注目，注目位置为坐标{x=-1320.06, y = 310.098, z=2140.031}，持续时间为2秒，并且为强制注目形式，不广播其他玩家
		local pos = {x=-1320.060, y=310.098, z=2140.031}
...
function action_EVENT_ENTER_REGION_378043(context, evt)
	...
	-- 在指定位置播放或停止音效资源
		local pos = {x=-1322.000, y=309.000, z=2128.000}
