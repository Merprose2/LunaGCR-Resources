...
local defs = {
	...
	transParam_Pos = {x = 219.000, y = 297.000, z = 2468.000},
...
function action_EVENT_GADGET_STATE_CHANGE_415028(context, evt)
	-- 触发镜头注目，注目位置为坐标{x = -494.959, y=157, z=3601.006}，持续时间为2秒，并且为强制注目形式，不广播其他玩家
		local pos = {x=-494.959, y=157.000, z=3601.006}
