...
function condition_EVENT_GADGET_CREATE_107008(context, evt)
	if 107001 ~= evt.param1 or GadgetState.Default ~= ScriptLib.GetGadgetStateByConfigId(context, base_info.group_id, evt.param1) then
		return false
	end
...
function action_EVENT_ENTER_REGION_107009(context, evt)
	...
	-- 触发镜头注目，注目位置为坐标{x = 164.179, y = 100.203, z=2980.093}，持续时间为2秒，并且为强制注目形式，不广播其他玩家
		local pos = {x=164.179, y=100.203, z=2980.093}
