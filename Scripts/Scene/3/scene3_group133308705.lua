...
function action_EVENT_ENTER_REGION_705002(context, evt)
	...
	-- 触发镜头注目，注目位置为坐标{x=-1255.373, y = 63.486, z=4809.144}，持续时间为3秒，并且为强制注目形式，不广播其他玩家
		local pos = {x=-1255.373, y=63.486, z=4809.144}
...
function action_EVENT_QUEST_FINISH_705003(context, evt)
	-- 触发镜头注目，注目位置为坐标{x=-1152.1, y = 111.508, z=4825.879}，持续时间为5秒，并且为强制注目形式，不广播其他玩家
		local pos = {x=-1152.100, y=111.508, z=4825.879}
	  local pos_follow = {x=0, y=0, z=0}
