...
function action_EVENT_SELECT_OPTION_474017(context, evt)
	...
	-- 触发镜头注目，注目位置为坐标{x=-1499.091, y = 195.652, z=3457.435}，持续时间为2秒，并且为强制注目形式，不广播其他玩家
		local pos = {x=-1499.091, y=195.652, z=3457.435}
...
function action_EVENT_ENTER_REGION_474035(context, evt)
	-- 触发镜头注目，注目位置为坐标{x=-1427.616, y = 204.794, z=3444.817}，持续时间为2秒，并且为强制注目形式，不广播其他玩家
		local pos = {x=-1427.616, y=204.794, z=3444.817}
	  local pos_follow = {x=0, y=0, z=0}
