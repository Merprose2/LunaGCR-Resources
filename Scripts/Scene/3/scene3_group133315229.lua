...
function action_EVENT_ENTER_REGION_229004(context, evt)
	...
	-- 触发镜头注目，注目位置为坐标{x = 134.202, y = 100.654, z=2947.128}，持续时间为2秒，并且为强制注目形式，不广播其他玩家
		local pos = {x=134.202, y=100.654, z=2947.128}
...
function condition_EVENT_GADGET_CREATE_229009(context, evt)
	if 229001 ~= evt.param1 or GadgetState.Default ~= ScriptLib.GetGadgetStateByConfigId(context, base_info.group_id, evt.param1) then
		return false
	end
