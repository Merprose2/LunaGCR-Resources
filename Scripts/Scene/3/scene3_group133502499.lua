...
monsters = {
	...
	{ config_id = 499005, drop_id = 1000100, persistent = true, monster_id = 25505201, pos = { x = -2451.880, y = 204.860, z = 9074.548 }, rot = { x = 0, y = 38.689, z = 0 }, level = 1, drop_tag = "采集动物", area_id = 5, pose_id = 9004 },
	{ config_id = 499007, drop_id = 1000100, persistent = true, monster_id = 25502202, pos = { x = -2442.759, y = 204.860, z = 9075.861 }, rot = { x = 0, y = 45.83, z = 0 }, level = 1, drop_tag = "采集动物", area_id = 5, pose_id = 0 },
}
...
gadgets = {
	{ config_id = 499002, gadget_id = 70211022, pos = { x = -2462.145, y = 205.132, z = 9079.230 }, rot = { x = 0, y = 116.273, z = 0 }, level = 1, route_id = 0, state = 101 },
