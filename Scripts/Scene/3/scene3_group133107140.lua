...
function condition_EVENT_GADGET_CREATE_140005(context, evt)
	if 140009 ~= evt.param1 or GadgetState.Default ~= ScriptLib.GetGadgetStateByConfigId(context, base_info.group_id, evt.param1) then
		return false
	end
...
function action_EVENT_SELECT_OPTION_140007(context, evt)
	...
	local pos = {x=-388.000,y=270.000,z=531.000}
