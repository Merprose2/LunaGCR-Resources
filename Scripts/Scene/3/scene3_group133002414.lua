...
function condition_EVENT_GADGET_CREATE_414019(context, evt)
	if 414007 ~= evt.param1 or GadgetState.Default ~= ScriptLib.GetGadgetStateByConfigId(context, base_info.group_id, evt.param1) then
		return false
	end
...
function action_EVENT_ANY_MONSTER_DIE_414031(context, evt)
	...
	local pos = {x=1480.000,y=268.000,z=-736.000}
