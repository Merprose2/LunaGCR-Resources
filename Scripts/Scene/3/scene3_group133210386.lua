...
function condition_EVENT_GADGET_CREATE_386006(context, evt)
	if 386001 ~= evt.param1 or GadgetState.GearStop ~= ScriptLib.GetGadgetStateByConfigId(context, base_info.group_id, evt.param1) then
		return false
	end
...
function condition_EVENT_GADGET_CREATE_386011(context, evt)
	if 386001 ~= evt.param1 or GadgetState.GearStart ~= ScriptLib.GetGadgetStateByConfigId(context, base_info.group_id, evt.param1) then
		return false
	end
