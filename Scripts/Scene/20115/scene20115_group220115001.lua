...
-- 怪物
monsters = {
	{ config_id = 1003, monster_id = 29050103, pos = { x = 0.000, y = 0.147, z = 13.100 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, title_id = 141, special_name_id = 2014101, mark_flag = 1 },
	{ config_id = 1004, monster_id = 29050104, pos = { x = 0.000, y = 0.147, z = 7.100 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, title_id = 142, special_name_id = 2014101, mark_flag = 7 }
}
...
gadgets = {
	...
	{ config_id = 1033, gadget_id = 70310102, pos = { x = 14.380, y = 0.135, z = 16.385 }, rot = { x = 0.000, y = 90.000, z = 0.000 }, level = 1 },
	{ config_id = 1034, gadget_id = 70310102, pos = { x = 14.380, y = 0.135, z = -1.790 }, rot = { x = 0.000, y = 90.000, z = 0.000 }, level = 1 },
	{ config_id = 1035, gadget_id = 70310102, pos = { x = 14.380, y = 0.135, z = -10.330 }, rot = { x = 0.000, y = 90.000, z = 0.000 }, level = 1 },
	{ config_id = 1036, gadget_id = 70310102, pos = { x = 14.380, y = 0.135, z = 7.990 }, rot = { x = 0.000, y = 90.000, z = 0.000 }, level = 1 },
	{ config_id = 1037, gadget_id = 70310102, pos = { x = -14.288, y = 0.135, z = 16.385 }, rot = { x = 0.000, y = 90.000, z = 0.000 }, level = 1 },
	{ config_id = 1038, gadget_id = 70310102, pos = { x = -14.288, y = 0.135, z = -10.330 }, rot = { x = 0.000, y = 90.000, z = 0.000 }, level = 1 },
	{ config_id = 1039, gadget_id = 70310102, pos = { x = -14.288, y = 0.135, z = -1.790 }, rot = { x = 0.000, y = 90.000, z = 0.000 }, level = 1 },
	{ config_id = 1040, gadget_id = 70310102, pos = { x = -14.288, y = 0.135, z = 7.990 }, rot = { x = 0.000, y = 90.000, z = 0.000 }, level = 1 },
	-- 灯光1--默认
	{ config_id = 1041, gadget_id = 70310103, pos = { x = 0.000, y = 0.000, z = 0.000 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	-- 灯光2
	{ config_id = 1042, gadget_id = 70310104, pos = { x = 0.000, y = 0.000, z = 0.000 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	-- 灯光3
	{ config_id = 1043, gadget_id = 70310105, pos = { x = 0.000, y = 0.000, z = 0.000 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	-- 发奖相关
	{ config_id = 1046, gadget_id = 70360001, pos = { x = 0.063, y = 0.147, z = 8.240 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	-- 发奖相关
	{ config_id = 1048, gadget_id = 70210106, pos = { x = 0.063, y = 0.147, z = 8.240 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, drop_tag = "女士", persistent = true, boss_chest = { monster_config_id = 1004, resin=60, life_time = 1800, take_num = 1} }
}
